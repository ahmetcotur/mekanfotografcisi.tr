...
$heroPattern = '/<div class="flex flex-wrap items-center justify-center gap-x-12 gap-y-6 mb-8 overflow-visible">.*?<\/div>\s*<\/div>\s*<\/div>/s';
$newContent = preg_replace($heroPattern, '<div id="hero-effect-root" class="overflow-visible min-h-[300px] flex items-center justify-center"></div>', $content);
if ($newContent !== null) {
    $content = $newContent;
}
