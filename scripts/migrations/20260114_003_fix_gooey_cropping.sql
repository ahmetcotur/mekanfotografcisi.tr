-- Migration: M20260114_003_Fix_Gooey_Cropping
-- Description: Fixes text cropping issues in hero section by increasing container heights and adding padding.
-- STATEMENT
        ...
        <div class="max-w-5xl mx-auto text-center">
            ...
            <h1 class="font-heading font-black text-4xl md:text-6xl lg:text-7xl text-white mb-10 leading-tight tracking-tight drop-shadow-2xl">
                <div class="flex flex-wrap items-center justify-center gap-x-6 gap-y-4 mb-4">
                    <div id="prefix-morph" class="h-16 md:h-20 lg:h-24 min-w-[200px] md:min-w-[380px] overflow-visible"></div>
                    <div id="suffix-morph" class="h-16 md:h-20 lg:h-24 min-w-[150px] md:min-w-[280px] text-transparent bg-clip-text bg-gradient-to-r from-brand-400 to-cyan-300 overflow-visible"></div>
                </div>
                <div class="text-white mt-2">Dönüştürüyoruz</div>
            </h1>
