-- Migration: M20260114_008_Homepage_Premium_Redesign
-- Description: Redesign homepage hero and stats to match locations page style and fix cropping.
...
<section class="relative min-h-[95vh] flex items-center justify-center overflow-hidden bg-slate-900" id="hero-slider">
    ...
    <!-- Content -->
    <div class="relative z-10 container mx-auto px-4 overflow-visible py-20">
        <div class="max-w-7xl mx-auto text-center overflow-visible">
            ...
            <h1 class="font-heading font-black text-5xl md:text-7xl lg:text-8xl text-white mb-16 leading-[1.1] tracking-tight drop-shadow-2xl overflow-visible">
                <div class="flex flex-wrap items-center justify-center gap-x-12 gap-y-6 mb-8 overflow-visible">
                    <div id="prefix-morph" class="h-24 md:h-32 lg:h-40 min-w-[320px] md:min-w-[550px] lg:min-w-[850px] overflow-visible"></div>
                    <div id="suffix-morph" class="h-24 md:h-32 lg:h-40 min-w-[220px] md:min-w-[450px] lg:min-w-[650px] text-transparent bg-clip-text bg-gradient-to-r from-brand-400 to-brand-300 font-black italic overflow-visible"></div>
                </div>
            ...
            <div class="flex flex-col sm:flex-row gap-8 justify-center items-center mb-20">
                <button onclick="openQuoteWizard()" class="group relative w-full sm:w-auto px-12 py-6 bg-brand-600 hover:bg-brand-500 text-white rounded-[2rem] font-black text-xl shadow-[0_20px_50px_rgba(14,165,233,0.4)] transition-all hover:scale-110 active:scale-95 overflow-hidden">
                    <span class="relative z-10">Hemen Fiyat Hesapla</span>
                    <div class="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
                </button>
                <a href="/portfolio" class="w-full sm:w-auto px-12 py-6 bg-white/5 hover:bg-white/10 text-white border border-white/20 rounded-[2rem] font-black text-xl backdrop-blur-xl transition-all hover:scale-110 active:scale-95 flex items-center justify-center gap-4">
                    Portfolyoyu İncele
            ...
            <!-- Quick Stats Cards (Similar to Locations Page) -->
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
                <div class="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 hover:bg-white/10 transition-all group">
                    <div class="text-4xl lg:text-5xl font-black text-brand-400 mb-2 group-hover:scale-110 transition-transform tracking-tighter">[stat_services]</div>
                    <div class="text-white/60 text-xs font-bold uppercase tracking-[0.2em]">Hizmet Alanı</div>
                </div>
                <div class="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 hover:bg-white/10 transition-all group">
                    <div class="text-4xl lg:text-5xl font-black text-brand-400 mb-2 group-hover:scale-110 transition-transform tracking-tighter">[stat_provinces]</div>
                    <div class="text-white/60 text-xs font-bold uppercase tracking-[0.2em]">Aktif İl</div>
                </div>
                <div class="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 hover:bg-white/10 transition-all group">
                    <div class="text-4xl lg:text-5xl font-black text-brand-400 mb-2 group-hover:scale-110 transition-transform tracking-tighter">[stat_districts]</div>
                    <div class="text-white/60 text-xs font-bold uppercase tracking-[0.2em]">Aktif İlçe</div>
                </div>
                <div class="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 hover:bg-white/10 transition-all group">
                    <div class="text-4xl lg:text-5xl font-black text-brand-400 mb-2 group-hover:scale-110 transition-transform tracking-tighter">[stat_projects]</div>
                    <div class="text-white/60 text-xs font-bold uppercase tracking-[0.2em]">Proje Teslimi</div>
                </div>
            </div>
        </div>
    </div>
...
<!-- Services Preview (Placeholder, replaced by template logic) -->
<section class="py-32 bg-white" id="hizmetler">
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            <!-- Dynamically populated by page-homepage.php -->
        </div>
    </div>
</section>
